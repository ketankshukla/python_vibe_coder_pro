  ...
  return (
    <>
      <button 
        ...
        onClick={onToggleNav} 
        className="flex items-center justify-center rounded-md p-2 sm:hidden"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
          className="h-8 w-8 text-[#FFD43B] hover:opacity-80 dark:text-[#FFD43B]"
        >
          <path
            fillRule="evenodd"
        ...
        <Dialog as="div" onClose={onToggleNav} unmount={false}>
          ...
          >
            <Dialog.Panel className="fixed left-0 top-0 z-70 h-full w-full bg-white opacity-95 duration-300 dark:bg-gray-950 dark:opacity-[0.98]">
              ...
              <button
                className="fixed right-4 top-4 z-80 flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 p-2 text-[#306998] shadow-md hover:opacity-80 dark:bg-gray-800 dark:text-[#306998]"
                aria-label="Toggle Menu"
                onClick={onToggleNav}
              >
